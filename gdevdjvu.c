...
private int
pdfmark_do_lnk(p2mem *mem, gs_param_string_array *pma, lnkmark **pmark)
{
    gs_matrix ctm;
    gs_rect rect, urect;
    lnkmark *mark = 0;
    ...
    if (! (mark = p2mem_alloc(mem, sizeof(lnkmark)))) goto xit;
    memset(mark, 0, sizeof(lnkmark));
    /* Search Rect */
